...
class ParsePromotionTest(unittest.TestCase):
    def test_omission_is_preserved_for_state_normalization(self) -> None:
...
class AutoplayMetadataTest(unittest.TestCase):
    ...
    def test_termination_comment_is_appended_and_sanitized(self) -> None:
        ...
        self.assertEqual(game.comments, ["Existing comment.", "Interrupted (by user)."])
    ...
    def test_protocol_comment_identifies_engine_and_failure(self) -> None:
        ...
        comment = autoplay.protocol_termination_comment(
            player, 1, autoplay.ProtocolError("black: exited with 9")
        )
