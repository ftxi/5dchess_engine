...
METRICS_FIELDS = (
    ...
    "rollout_black_wins",
    "rollout_stalemates",
    "rollout_actions_total",
    "rollout_actions_max",
    "rollout_seconds",
    "evaluation_seconds",
    "cutoff_score_sum",
    "cutoff_score_abs_sum",
    "cutoff_score_squared_sum",
    "cutoff_score_min",
    "cutoff_score_max",
    "terminal_tree_evaluations",
    "unique_terminal_tree_nodes",
    "simulation_tree_depth_sum",
    "simulation_tree_depth_max",
    "mcts_nodes_admitted",
    "root_actions_discovered",
    "root_actions_visited",
...
def record_go_metrics(
    ...
    row = {
        ...
        "rollout_white_wins": player.last_engine_stats.get("rollout_white_wins", ""),
        "rollout_black_wins": player.last_engine_stats.get("rollout_black_wins", ""),
        "rollout_stalemates": player.last_engine_stats.get("rollout_stalemates", ""),
        "rollout_actions_total": player.last_engine_stats.get("rollout_actions_total", ""),
        "rollout_actions_max": player.last_engine_stats.get("rollout_actions_max", ""),
        "rollout_seconds": player.last_engine_stats.get("rollout_seconds", ""),
        "evaluation_seconds": player.last_engine_stats.get("evaluation_seconds", ""),
        "cutoff_score_sum": player.last_engine_stats.get("cutoff_score_sum", ""),
        "cutoff_score_abs_sum": player.last_engine_stats.get("cutoff_score_abs_sum", ""),
        "cutoff_score_squared_sum": player.last_engine_stats.get("cutoff_score_squared_sum", ""),
        "cutoff_score_min": player.last_engine_stats.get("cutoff_score_min", ""),
        "cutoff_score_max": player.last_engine_stats.get("cutoff_score_max", ""),
        "terminal_tree_evaluations": player.last_engine_stats.get("terminal_tree_evaluations", ""),
        "unique_terminal_tree_nodes": player.last_engine_stats.get("unique_terminal_tree_nodes", ""),
        "simulation_tree_depth_sum": player.last_engine_stats.get("simulation_tree_depth_sum", ""),
        "simulation_tree_depth_max": player.last_engine_stats.get("simulation_tree_depth_max", ""),
        "mcts_nodes_admitted": player.last_engine_stats.get("mcts_nodes_admitted", ""),
        "root_actions_discovered": player.last_engine_stats.get("root_actions_discovered", ""),
        "root_actions_visited": player.last_engine_stats.get("root_actions_visited", ""),
        "selected_action_visits": player.last_engine_stats.get("selected_action_visits", ""),
        "second_action_visits": player.last_engine_stats.get("second_action_visits", ""),
        "status": status,
    }
